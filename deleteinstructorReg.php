...
if (isset($_POST['delete'])) {
    ...
    // Call the user-defined function to delete the instructor
    $deleteFunction = "SELECT DeleteInstructorByUsername(?) as result";
    ...
    if ($deleteStmt) {
        ...
        if (mysqli_stmt_execute($deleteStmt)) {
            ...
            if ($aff > 0) {
                echo "Instructor with username $username has been deleted successfully.";
            } else {
                echo "No instructor found with username $username.";
            }
        } else {
